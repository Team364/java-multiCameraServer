...
public final class Main {
  ...
  public static class MyPipeline implements VisionPipeline {
	...
	public void setFilterContours ( double inFilterContoursMinArea,
		 							double inFilterContoursMinPerimeter,
		 							double inFilterContoursMinWidth,
		 							double inFilterContoursMaxWidth,
									double inFilterContoursMinHeight,
									double inFilterContoursMaxHeight,
									double[] inFilterContoursSolidity,
									double inFilterContoursMaxVertices,
									double inFilterContoursMinVertices,
									double inFilterContoursMinRatio,
									double inFilterContoursMaxRatio) {
