...
set CLASSPATH=%APP_HOME%\lib\java-multiCameraServer.jar;%APP_HOME%\lib\wpiHal.jar;%APP_HOME%\lib\ntcore.jar;%APP_HOME%\lib\wpiutil.jar;%APP_HOME%\lib\wpilibj.jar;%APP_HOME%\lib\cscore.jar;%APP_HOME%\lib\opencv-344.jar;%APP_HOME%\lib\cameraserver.jar;%APP_HOME%\lib\gson-2.8.5.jar
